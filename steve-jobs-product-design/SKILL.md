---
name: steve-jobs-product-design
description: Product design auditor based on Steve Jobs' principles. Use when reviewing product decisions, UI designs, feature scope, or user experience. Emphasizes simplicity, taste, and ruthless focus.
---
...
**Core concepts**:
- [Philosophy](philosophy.md) — Simplicity as the ultimate sophistication
- [Principles](principles.md) — The key product design principles
- [Decision Framework](decision-framework.md) — How to make product decisions
- [Audit Checklist](audit-checklist.md) — Systematic product review checklist
